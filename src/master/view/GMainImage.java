 ...
 * used in MiniChooser without requiring a long list of image definitions in
 * the MiniChooser class.
 */
public enum GMainImage {
	
	BACKGROUND("mainscreen_backgr.jpg"),
	GAME1_PIC("game1_pic.png"),
	GAME2_PIC("game2_pic.png"),
	GAME3_PIC("game3_pic.png"),
	CRAB("crab_anim_frames.png"),
	BIRD("bird_anim_frames.png"),
	EXIT_DEFAULT("exit_default.png"),
	EXIT_CLICKED("exit_clicked.png"),
	EXIT_HOVER("exit_hover.png");
