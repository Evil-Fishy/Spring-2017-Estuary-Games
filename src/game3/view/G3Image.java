 ...
 * used in MiniThree without requiring a long list of image definitions in
 * the MiniThree class.
 * 
 ...
 */
public enum G3Image {
	BACKGROUND("wood-table.png"),
	MARKER("die_placement_marker.png"),
	MARKER_SET("die_placement_marker_set.png"),
	DIE("die_default.png"),
	DIE_FRAMES("die_rolling_frames.png"),
	ARROWS("arrows.png"),
	STORYPANEL_BG("storypanel_border.png"),
	TUT_BOARD("tutorial.png"),
	FINGER("finger.png");
	
	private BufferedImage origImg, scaledImg;
	private final String filePath;
	private final String directory = "resources/game3/";
